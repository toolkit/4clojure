(ns language-of-a-dfa.core
  (:require [clojure.test :refer :all]))

;; Problem 164 - Language of a DFA
;; http://www.4clojure.com/problem/164
;;
;; Write a function that takes as input a DFA definition
;; and returns a sequence enumerating all strings in the
;; language recognized by the DFA.
;;
;; Note: Although the DFA itself is finite and only recognizes
;; finite-length strings it can still recognize an infinite set
;; of finite-length strings. And because stack space is finite,
;; make sure you don't get stuck in an infinite loop that's not
